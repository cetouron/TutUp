<template>
  <v-row>
    ...
    >
      <v-col>
        ...
        >
          ...
          <span
            class="black--text text--lighten-2 mr-1"
            align="right"
            justify="right"
          >
            <span class="font-weight-bold" align="left"> Boudboule43 : </span>
            {{ product.comm1 }}
          </span>
        </v-card>
        <br />
        ...
        >
          ...
          <span
            ...
            justify="right"
          >
            <span class="font-weight-bold" align="left"> MarieSophie : </span>
            {{ product.comm2 }}
          </span>
        </v-card>
        <br />
        ...
        >
          ...
          <span
            ...
            justify="right"
          >
            <span class="font-weight-bold" align="left"> HerveFR : </span>
            {{ product.comm3 }}
          </span>
        </v-card>
      </v-col>
    ...
    <v-col sm="8" md="5" align="left" justify="center">
      <v-col align="center" justify="center" class="bioEtAutre">
...
export default {
  data() {
    return {
      ...
      nbAvis: "8",
      comm:
        "Salut les zamis il est bon ce mec je recommande, a bientôt avec planet sushi",
      comm1: "Cette personne a un sérieux problème... Engagez-le !",
      comm2:
        "Si je devais donner le nom d'un dessin animé pour résumer... 'Les Zinzins de l'espace', il propose du dentifrice au goûté et a la gueule d'un Bogdanov.",
      form:
        "Dans la vie je voulais faire de la danse classique de base, bon voyez ça mal tourné, alors aujourd'hui je fais du tutorat. Mais sinon bon alors bah j'ai fait un Bac C. Ouai un Bac C, à vrai dire j'ai 58 ans, donc forcement à un moment ça joue.",
      bio:
        "Aujourd'hui j'ai donc décidé de me consacré à l'escalde en milieu aquatique. Voyez la dorsale dans l'océan, bah je me dis que bon je pourrais y escalader mais dans le sens inserve des aiguilles du montre. Mon tutorat ça sera plus de la SVT, parce que j'avais une prof et l'époque et elle avait un",
      autre:
        "Houlà mais je suis torp long j'ai pas pu finir mon histoire dans la premier paragraphe. Qui sont ces développeurs qui ne laissent que 12000 caractères pour se décrire ? Pense t'il une peronne ne se résume qu'en si peu de vie ? Ayez honte, sérieusement. Bon j'en étais ou déjà ? Et oui donc là elle me dit 'Ca va pas se passer comme ça jeune homme.' Et je ne suis sorti de prison que depuis quelques mois.",
    };
  },
  props: {
